...
public class AverageSpeedControl implements WindowFunction<
        Tuple8<Integer, Integer, Integer, Long, Integer, Boolean, Integer, Integer>, Tuple4<Integer, Integer, Integer, Double>,
        Tuple, TimeWindow> {
    @Override
    public void apply(Tuple key, TimeWindow window, Iterable<Tuple8<Integer, Integer, Integer, Long, Integer, Boolean, Integer, Integer>> input,
        ...
        if ((seg1==52 || seg1==56) && (seg2==52 || seg2==56) && (seg1!=seg2) && (avgspeed > 60.0)) {
            out.collect(new Tuple4<>(time1, time2, vid, avgspeed));
        }
    }
}